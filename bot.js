...
const row=new ActionRowBuilder().addComponents(s.c.map((c,i)=>new ButtonBuilder().setCustomId(“ch_”+msg.channel.id+”*”+msg.author.id+”*”+i).setLabel(c.l).setStyle(i===0?ButtonStyle.Primary:i===1?ButtonStyle.Secondary:ButtonStyle.Danger)));
...
const row=new ActionRowBuilder().addComponents(s.c.map((c,i)=>new ButtonBuilder().setCustomId(“ch_”+interaction.channel.id+”*”+interaction.user.id+”*”+i).setLabel(c.l).setStyle(i===0?ButtonStyle.Primary:i===1?ButtonStyle.Secondary:ButtonStyle.Danger)));
